...
//	private static final boolean DEBUG = false;	// FIXME 実働時はfalseにすること
	...
	public static MessageDialogFragment showDialog(final AppCompatActivity parent, final int requestCode, final int id_title, final int id_message, final String[] permissions) {
