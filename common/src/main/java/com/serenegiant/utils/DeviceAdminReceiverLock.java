...
public class DeviceAdminReceiverLock extends DeviceAdminReceiver {
	...
	public static void requestScreenLock(@NonNull final AppCompatActivity activity, final boolean finish) {
	 ...
	 */
	private static boolean checkScreenLock(@NonNull final AppCompatActivity activity, final boolean finish) {
	...
	public static boolean onActivityResult(@NonNull final AppCompatActivity activity, final int requestCode, final int resultCode, final Intent data) {
		switch (requestCode) {
