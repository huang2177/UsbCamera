...
//********************************************************************************
    ...
    public static void requestOpenDocument(@NonNull final AppCompatActivity activity,
     ...
     */
    @TargetApi(Build.VERSION_CODES.KITKAT)
    public static void requestCreateDocument(@NonNull final AppCompatActivity activity,
                                             final String mime, final int requestCode) {
    ...
    public static Uri requestStorageAccess(@NonNull final AppCompatActivity activity,
                                           final int requestCode) {
